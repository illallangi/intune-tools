...
from msgraph_beta.generated.device_management.configuration_policies.configuration_policies_request_builder import (
    ConfigurationPoliciesRequestBuilder,
)
        ...
        *args,
        ...
        for arg in args or ([] if cached_all else [None]):
            ...
            if arg not in cache:
                while True:
                    if next_link:
                        result = await self.client.device_management.configuration_policies.with_url(
                            next_link,
                        ).get(
                        ...
                        result = await self.client.device_management.configuration_policies.get(
                            request_configuration=request_configuration,
                        )
